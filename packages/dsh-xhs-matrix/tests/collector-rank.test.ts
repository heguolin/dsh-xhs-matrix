...
describe('rankViralItems', () => {
  ...
  it('高权重笔记相近内容加分', () => {
    const notes: PublishedNote[] = [{ id: 'n1', personaId: 'p1', title: 'AI 提效工具实测', copy: '', publishedAt: '2026-08-01', source: 'import', weight: 5, createdAt: '2026-08-01T00:00:00.000Z', updatedAt: '2026-08-01T00:00:00.000Z' }]
