...
*/
function splitLegacyForbidden(value) {
...
var DefaultContentQualityService = class {
	...
	check(text, persona) {
		const hits = scanForbiddenWords(text, persona.forbiddenWords ?? splitLegacyForbidden(persona.forbiddenExpressions) ?? []);
		return {
			report: {
...
//#endregion
export { splitLegacyForbidden as a, scanForbiddenWords as i, MatrixStoreError as n, createQualityService as r, MatrixStore as t };
