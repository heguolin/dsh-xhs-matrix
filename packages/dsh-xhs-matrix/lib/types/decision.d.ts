...
/** 标题是否命中黑名单（子串匹配）。 */
export declare function matchesNegative(title: string, negative: NegativeTopic): boolean;
/**
 ...
 * @returns 候选选题。
 */
export declare function filterTopics(topics: Topic[], negatives: NegativeTopic[], accountId: string, todayDrafts: Draft[]): Topic[];
/**
 * 从候选中选择一个选题。
